...
static int l_AllLeave(lua_State* L)
{
    instruct_59();
    return 0;
}
...
static int l_LightScene(lua_State* L)
{
    instruct_13();
    return 0;
}
static int l_DarkScene(lua_State* L)
{
    instruct_14();
    return 0;
}
static int l_Dead(lua_State* L)
{
    instruct_15();
    return 0;
}
...
static int l_LeaveTeam(lua_State* L)
{
    instruct_21(LI(-1));
    return 0;
}
...
static int l_PlayWave(lua_State* L)
{
    instruct_67(LI(-1));
    return 0;
}
...
static int l_GetCurrentScene(lua_State* L)
{
    lua_pushnumber(L, CurScene);
    return 1;
}
static int l_GetCurrentEvent(lua_State* L)
{
...
static int l_AskSoftStar(lua_State* L)
{
    instruct_51();
    return 0;
}
static int l_WeiShop(lua_State* L)
{
    instruct_64();
    return 0;
}
static int l_OpenAllScene(lua_State* L)
{
    instruct_54();
    return 0;
}
static int l_ShowEthics(lua_State* L)
{
    instruct_52();
    return 0;
}
static int l_ShowRepute(lua_State* L)
{
    instruct_53();
    return 0;
}
static int l_ChangeMMapMusic(lua_State* L)
{
    instruct_8(LI(-1));
    return 0;
}
static int l_ZeroAllMP(lua_State* L)
{
    instruct_22();
    return 0;
}
static int l_SetOneUsePoi(lua_State* L)
{
    instruct_23(LI(-2), LI(-1));
    return 0;
}
static int l_Add3EventNum(lua_State* L)
{
...
static int l_AddAptitude(lua_State* L)
{
    instruct_34(LI(-2), LI(-1));
    return 0;
}
static int l_SetOneMagic(lua_State* L)
{
...
static int l_AddEthics(lua_State* L)
{
    instruct_37(LI(-1));
    return 0;
}
static int l_ChangeScenePic(lua_State* L)
{
    instruct_38(LI(-4), LI(-3), LI(-2), LI(-1));
    return 0;
}
static int l_OpenScene(lua_State* L)
{
    instruct_39(LI(-1));
    return 0;
}
...
static int l_AddSpeed(lua_State* L)
{
    instruct_45(LI(-2), LI(-1));
    return 0;
}
static int l_AddMP(lua_State* L)
{
    instruct_46(LI(-2), LI(-1));
    return 0;
}
static int l_AddAttack(lua_State* L)
{
    instruct_47(LI(-2), LI(-1));
    return 0;
}
static int l_AddHP(lua_State* L)
{
    instruct_48(LI(-2), LI(-1));
    return 0;
}
static int l_SetMPPro(lua_State* L)
{
...
static int l_AddRepute(lua_State* L)
{
    instruct_56(LI(-1));
    return 0;
}
static int l_BreakStoneGate(lua_State* L)
{
    instruct_57();
    return 0;
}
static int l_FightForTop(lua_State* L)
{
    instruct_58();
    return 0;
}
...
static int l_SetSexual(lua_State* L)
{
...
static int l_setteam(lua_State* L)
{
    TeamList[LI(-2)] = LI(-1);
    return 0;
}
static int l_getteam(lua_State* L)
{
